...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
        ...
        speedControllerGroupLeft = new SpeedControllerGroup(talonSRX1, talonSRX2 , talonSRX3 );
        addChild("Speed Controller Group Left",speedControllerGroupLeft);
        
        
        talonSRX4 = new WPI_TalonSRX(10);
        
        
        
        talonSRX5 = new WPI_TalonSRX(11);
        
        
        
        talonSRX6 = new WPI_TalonSRX(12);
        
        
        
        speedControllerGroupRight = new SpeedControllerGroup(talonSRX4, talonSRX5 , talonSRX6 );
    ...
    public void arcadeDrive(double forward, double head){
        differentialDrive.arcadeDrive(forward, head);
    }

    public void curvatureDrive(double forward, double head, boolean isQuickTurn){
        differentialDrive.curvatureDrive(forward, head, isQuickTurn);    }
    ...
    public void Move_abit(){
        differentialDrive.tankDrive(0.25, 0.25);
    }

    public void Back_abit(){
        differentialDrive.tankDrive(0.25, 0.25);
    }
